...
<meta name="description"
      content="Mapa de eventos deportivos con el que podrás planificar tu calendario deportivo con deportes como maratón, ciclismo, esquí, carreras populares, zonas de escalada o running.">
...
function initialize() {
    ...
    google.maps.event.addListenerOnce(map, 'idle', function () {
        ...
        if (window.location.hash.length > 0) {
            ...
            google.maps.event.trigger(gmarkers.filter(function (objeto) {
                return objeto.hasOwnProperty("id") && objeto.id == evento_id;
            })[0], 'click');
        }
    });
    ...
    jQuery('#search').typeahead({
        ...
        onselect: function (obj) {
            var marker = gmarkers.filter(function (objeto) {
                return objeto.hasOwnProperty("title") && objeto.title == obj;
            })[0];
...
function show(query) {
    for (var i = 0; i < gmarkers.length; i++) {
        if ((query.hasOwnProperty("category") &&
            gmarkers[i].category == query.category && !$("#filter_sub_" + gmarkers[i].subcategory).hasClass("inactive")) ||
            (query.hasOwnProperty("subcategory") &&
                gmarkers[i].subcategory == query.subcategory && !$("#filter_" + gmarkers[i].category).hasClass("inactive") ) ||
            (query.hasOwnProperty("month") &&
                gmarkers[i].date != undefined &&
                gmarkers[i].date.getMonth() == query.month && !$("#filter_" + gmarkers[i].category).hasClass("inactive") && !$("#filter_sub_" + gmarkers[i].subcategory).hasClass("inactive"))
            ) {
...
<div class="topbar" id="topbar">
    <div class="wrapper">
        <div class="right">
            <div class="share">
                <a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo $domain ?>"
                   data-text="<?php echo $twitter['share_text'] ?>" data-via="<?php echo $twitter['username'] ?>"
        ...
        <div class="left">
            ...
            <div class="buttons">
                <a href="#modal_info" class="btn btn-large btn-info" data-toggle="modal"><i
                        class="icon-info-sign icon-white"></i><?php echo _("Sobre este mapa"); ?></a>
                <a href="#modal_faq" class="btn btn-large btn-info" data-toggle="modal"><i
                        class="icon-info-sign icon-white"></i>FAQ</a>
                <a href="#modal_add" class="btn btn-large btn-success" data-toggle="modal"><i
                        class="icon-plus-sign icon-white"></i><?php echo _("Añade tu evento"); ?></a>
            </div>
            <div class="search">
                <input type="text" name="search" id="search" placeholder="<?php echo _("Busca competiciones..."); ?>"
            ...
            <div class="combob">
                <select class="combob form-control bfh-languages" data-language="<?php echo $lang; ?>"
                        data-available="en,es_ES">
                </select>
            </div>
        </div>
    </div>
...
<div class="modal hide in" id="modal_info" style="margin-top: -310px!important;">
    ...
    <div class="modal-body">
        ...
        <a href="http://www.twitter.com/ <?php echo $twitter['username'] ?>"
           target="_blank">@<?php echo $twitter['username'] ?></a>
        <br>
...
<div class="modal hide in" id="modal_faq">
    ...
    <div class="modal-body">
        <ol>
            ...
            <li>
                <a href="#8"><?php echo _("Mi evento no está situado bien en el mapa de Sportyguest Sports Map:"); ?></a>
            </li>
            <li>
                <a href="#9"><?php echo _("Me parece una idea muy interesante y me gustaría ayudar a promocionarlo:"); ?></a>
            </li>
        ...
        <ol>
            ...
            <li>
                <a name="9"><?php echo _("Me parece una idea muy interesante y me gustaría ayudar a promocionarlo:"); ?></a>
    ...
    <form method="POST" action="add.php" id="modal_addform" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <fieldset>
                ...
                <div class="control-group" id="control_group_owner_phone">
                    <label class="control-label" for="add_owner_phone"><?php echo _("Tu teléfono"); ?></label>

                    <div class="controls">
                        <input type="text" class="input-xlarge" name="owner_phone" id="add_owner_phone" maxlength="100">
                ...
                <div class="control-group" id="control_group_start_time">
                    <label class="control-label" for="add_start_time"><?php echo _("Hora de inicio"); ?></label>

                    <div class="controls">
                        <input type="text" class="input-xlarge" name="start_time" id="add_start_time" maxlength="100">

                        <p class="help-block">
                            <?php echo _("La hora a la que empieza el evento."); ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="control-group" id="control_group_periodo_inscripcion">
                    <label class="control-label" for="add_periodo_inscripcion"><?php echo _("Período de inscripción"); ?></label>

                    <div class="controls">
                        <input type="text" class="input-xlarge" name="periodo_inscripcion" id="add_periodo_inscripcion" maxlength="100">

                        <p class="help-block">
                            <?php echo _("El período de inscripción del evento."); ?>
                        </p>
                    </div>
                </div>
                <div class="control-group" id="control_group_difficulty">
                    <label class="control-label" for="input01"><?php echo _("Nivel de dificultad"); ?></label>

                    <div class="controls">
                        <select name="difficulty" id="add_difficulty" class="input-xlarge">
                            <option value="facil">Fácil</option>
                            <option value="media">Media</option>
                            <option value="dificil">Difícil</option>
                            <option value="extra">Extra difícil</option>
                        </select>

                        <p class="help-block">
                            <?php echo _("Nivel de dificultad de la competición."); ?>
                        </p>
                    </div>
                </div>
                  ...
                  <span class="btn btn-file">
                    ...
                    <input type="file" id="image" name="image"/>
                            ...
                            <a href="#" class="btn fileupload-exists"
                               data-dismiss="fileupload"><?php echo _("Eliminiar"); ?></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="control-group" id="control_group_description">
                    ...
                    <div class="controls">
                        <textarea class="input input-xlarge" id="add_description" name="description" maxlength="600"
                                  rows="8"></textarea>
            ...
            $.ajax({
                ...
                dataType: "json"
                    ...
                    if (data.code == "success") {
                        ...
                        var mandatory_fields = ["owner_name", "owner_email", "title", "category", "subcategory", "address", "datepicker", "uri", "image", "price", "description", "owner_phone", "start_time", "periodo_inscripcion", "difficulty"];
